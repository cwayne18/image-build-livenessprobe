# image-build-livenessprobe

This repo builds hardened, statically-linked Go binaries from
[kubernetes-csi/livenessprobe](https://github.com/kubernetes-csi/livenessprobe) and packages them in a minimal
...
- `cwayne18/hardened-livenessprobe` — CSI Liveness Probe Sidecar
